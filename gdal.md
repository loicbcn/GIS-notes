```bat
rem Assemblage de tuiles ecw/jp2 en jp2 (JP2OpenJPEG)
rem Passer par un .vrt puis faire un translate car le driver JP2OpenJPEG ne permet pas de faire l'assemblage directement.
